      ...
      <div className="mx-auto max-w-[700px] px-6 py-10">
          ...
          <div className="bg-white rounded-2xl border border-border p-8">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder='e.g., "Kitchen Sink Replacement" or "Interior Painting — 3 Bedrooms"'
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                placeholder={"Example: We need to replace the kitchen sink and faucet in our 10-year-old home. The current sink is a single-basin stainless steel (33\" x 22\") and we'd like to upgrade to a double-basin undermount. The existing plumbing connections are in good condition but the countertop may need to be cut to fit the new sink. We prefer brushed nickel fixtures. Access is straightforward — no tight spaces or unusual plumbing layout."}
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Include measurements, material preferences, and any constraints
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Show the current state of the area — helps contractors
                  ...
                  {beforePreviews.map((url, i) => (
                    <div key={i} className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          removePhoto(i, setBeforePhotos, setBeforePreviews)
                        }
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Share reference images of the look or result you want to
                achieve.
              </p>
              <div
                className="border-2 border-dashed border-border rounded-xl p-6 text-center cursor-pointer hover:border-accent/40 transition"
                  ...
                  {expectedPreviews.map((url, i) => (
                    <div key={i} className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          removePhoto(i, setExpectedPhotos, setExpectedPreviews)
                        }
                        className="absolute -top-2 -right-2 w-5 h-5 bg-foreground text-white rounded-full text-xs flex items-center justify-center hover:bg-red-500 transition"
                      >
                        ×
          ...
          <div className="bg-white rounded-2xl border border-border p-8">
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-xl p-4 mb-8 flex items-start gap-3">
              ...
              <p className="text-sm text-foreground">
                ...
                bid. Only your{" "}
                <strong className="text-accent">city and ZIP code</strong> will
                be shown so contractors can confirm you&apos;re within their
                service area.
              </p>
            </div>
        ...
        {step === 4 && (
          <div className="bg-white rounded-2xl border border-border p-8">
            ...
            <p className="text-muted-foreground mb-8">
              Double-check everything before submitting. You can go back to edit
              any section.
            </p>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-right">
                    {selectedServices
                      .map((s) => getServiceLabel(s, services))
                      .join(", ")}
                  </span>
                </div>
                <div className="flex justify-between">
